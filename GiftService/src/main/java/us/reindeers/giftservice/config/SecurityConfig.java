package us.reindeers.giftservice.config;
        ...
        http
                ...
                .authorizeHttpRequests(authorizeHttpRequests ->
                        authorizeHttpRequests
                                .requestMatchers("/api/gifts/receiver/**").authenticated()
                                .requestMatchers("/api/gifts/donor/**").authenticated()
                                .requestMatchers("/api/gifts", "/api/gifts/**", "/api/gifts/review/**" , "/api/gifts/subReview/**/**").permitAll()
                                .anyRequest().denyAll()
                )
